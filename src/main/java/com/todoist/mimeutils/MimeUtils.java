...
/**
 * Helper methods for detecting mime types.
 *
 * Borrows code from libcore's MimeUtils.java, openjdk's URLConnection.java and android's DefaultFileNameMap.java,
...
public class MimeUtils {
    ...
    private static void add(String mimeType, String extension) {
        // If we have an existing x --> y mapping, we do not want to override it with another mapping x --> ?. This is
        // mostly because of the way the mime-type map above is constructed (if a mime type maps to several extensions
        // the first extension is considered the most popular and is added first; we do not want to overwrite it later).
    ...
    public static boolean hasMimeType(String mimeType) {
        ...
        return sMimeTypeToExtensionMap.containsKey(mimeType);
    }
    ...
    public static boolean hasExtension(String extension) {
        ...
        return sExtensionToMimeTypeMap.containsKey(extension);
    }
    ...
    /**
     * Returns the extension for the given filename. Also works with urls, though it's likely to return null.
     *
    ...
    public static String getExtension(String filename) {
        ...
        return extension != null ? extension.toLowerCase(Locale.US) : null;
    }

    /**
     * Tries to determine the type of an input stream based on the characters at the beginning of the input stream.
     *
     * Ideally, this routine would not be needed. But many http servers return the incorrect content type; in addition,
     * there are many nonstandard extensions. Direct inspection of the bytes to determine the content type is often
     * more
    ...
    public static String guessMimeTypeFromInputStream(InputStream is) throws IOException {
        ...
        if (c1 == 0xAC && c2 == 0xED) {
            return "application/x-java-serialized-object"; // Next two bytes are version number, currently 0x00 0x05.
        }
        ...
        if (c1 == 0xFF && c2 == 0xD8 && c3 == 0xFF) {
            ...
            /**
             * File format used by digital cameras to store images. Exif Format can be read by any application
             * supporting JPEG. Exif Spec can be found at: http://www.pima.net/standards/it10/PIMA15740/Exif_2-1.PDF.
             */
        ...
        if (c1 == 'R' && c2 == 'I' && c3 == 'F' && c4 == 'F') {
            return "audio/x-wav"; // I don't know if this is official but evidence suggests that .wav files start with "RIFF" - brown.
        }
